 ...
 * ===========================================================================
 *
 * Global defines for video mode 42
 *
 * ===========================================================================
 */
...
#define VMODE_ASM_SOURCE "videoMode42/videoMode42core.s"
#define VMODE_C_SOURCE "videoMode42/videoMode42.c"
#define VMODE_C_PROTOTYPES "videoMode42/videoMode42.h"
#define VMODE_FUNC sub_video_mode42
...
#define HSYNC_USABLE_CYCLES 246

/* Location of palette buffer. Normally displaces stack */

#ifndef M42_PALBUF
	#define M42_PALBUF       0x1000
