...
const unsigned char imgfont[] __attribute__ ((section (".tiles"))) = {
...
/* Multicolor image palette */

const unsigned char imgpal[] PROGMEM = {
 0x0A, 0x11, 0x52, 0x13, 0x1A, 0x9B, 0x5C, 0x63, 0xA4, 0xAD, 0xB6, 0x7F, 0xFF, 0xFF, 0xFF, 0xFF
};
