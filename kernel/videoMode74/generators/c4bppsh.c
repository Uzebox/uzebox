/*
**  Converts GIMP header to 4bpp Uzebox Mode 74 sprites, C header.
**
...
int main(void)
{
 ...
 printf("\n");
 printf("/* 4bpp sprite palette (color 0 is transparent) */\n");
 printf("\n");
 printf("const unsigned char sprpal[] PROGMEM = {\n");
 ...
 printf("\n");
 printf("/* 4bpp sprite data (%u sprites; %u bytes) */\n", width >> 3, width << 2);
 printf("\n");
 printf("const unsigned char sprdata[] __attribute__ ((section (\".imgdata\"))) = {\n");
 printf(" ");
